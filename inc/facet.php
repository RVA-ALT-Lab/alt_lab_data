<div class="row facet-project">
	<div class="facet-data workshop-title col-md-3">TITLE</div>
	<div class="due-date facet-data col-md-2">DUE</div>
	<div class="alt-lab-lead facet-data col-md-2">LEAD</div>
	<div class="department facet-data col-md-2">DEPT</div>
	<div class="design facet-data col-md-2">TYPE</div>
</div>

<?php while ( have_posts() ): the_post(); ?>
<div class="row facet-workshop">
		<div class="facet-data workshop-title col-md-3"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></div> 
